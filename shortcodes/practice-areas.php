...
add_filter('manage_practice_areas_posts_columns','practice_areas_columns');
function practice_areas_columns(){
    $columns = array(
        'cb'=>'cb',
        'title'=>'Title',
        'order'=>'Order',
...
add_filter('manage_edit-practice_areas_sortable_colummns','practice_areas_sortable_columns');
function practice_areas_sortable_columns($columns){
    $columns['order'] = 'order';
    return $columns;

}
add_action('manage_practice_areas_posts_custom_column','practice_areas_show_columns');
